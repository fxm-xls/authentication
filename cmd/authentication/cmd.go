...
import (
	...
	"bigrule/services/authentication/router"
	"context"
	"fmt"
...
var (
	...
	StartCmd   = &cobra.Command{
		Use:          "authentication",
		Short:        "Start API authentication",
		Example:      "bigrule authentication -c config/settings.yml",
		SilenceUsage: true,
...
func run() error {
	if viper.GetString("bigrule.authentication.application.mode") != "debug" {
	...
	go func() {
		...
		microService:= web.NewService(
			web.Name("authentication-service"),
